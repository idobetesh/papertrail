...
describe('Duplicate Detection', () => {
  describe('formatDuplicateWarning', () => {
    it('should format exact duplicate warning correctly', () => {
      ...
      const result = formatDuplicateWarning(duplicate, 'https://storage.example.com/new-file', 123, 456);
  ...
  describe('Duplicate matching logic', () => {
    ...
    it('should not match if amounts differ', () => {
      const extraction1 = createExtraction({ total_amount: 100.00 });
      const extraction2 = createExtraction({ total_amount: 100.50 });
