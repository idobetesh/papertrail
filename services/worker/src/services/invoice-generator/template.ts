    ...
    <div class="logo-section">
      ${
        logoBase64
          ...
          : '<div style="width: 80px; height: 80px; background: #e5e7eb; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 24px; color: #666;">📄</div>'
      }
    </div>
  </div>
